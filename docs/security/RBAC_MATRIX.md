...
| Role | leads | students | cases | contracts | payments | tasks | assessments | roadmaps | profile_evidence | writing | documents | admission_master | university_choices | applications | offers | scholarship_applications | visa | visa_checklist_templates | pre_departure | enrollment | partner | partner_programs | partner_documents | partner_student_links | commission_rules | commission_transactions | reports | portal | jobs | users | audit_logs |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| EXECUTIVE_DIRECTOR | view, create, edit, assign, convert | view, create, edit, archive, export | view, edit, assign, close | view, create, edit, approve, send, sign, amend, export | view, export | view, create, edit, assign | view, create, edit, approve | view, create, edit, approve | view, create, edit | view, create, edit | view, create, download, edit, share, archive | view, create, edit, verify | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, export | — | — | view | view |
| DEPARTMENT_MANAGER | view, create, edit, assign, convert | view, create, edit, archive, export | view, edit, assign, close | view, create, edit, approve, send, sign, amend, export | view, export | view, create, edit, assign | view, create, edit, approve | view, create, edit, approve | view, create, edit | view, create, edit | view, create, download, edit, share, archive | view, create, edit, verify | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, export | — | — | — | — |
| CONSULTANT | — | view, edit | view, edit, assign, close | — | — | view, create, edit, assign | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, download, edit, share, archive | view | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view, create, edit | view | view, create, edit | view, create, edit | — | — | — | — | — | — | view | — | — | — | — |
| DOCUMENT_SPECIALIST | — | view | view | — | — | view, create, edit, assign | view | view | view | view | view, create, download, edit, share, archive | view | view | view, create, edit | view | view | view, create, edit | view | view, create, edit | view | view | — | view | — | — | — | view | — | — | — | — |
| SALES_MARKETING | view, create, edit, assign, convert | — | — | — | — | — | — | — | — | — | — | view | — | — | — | — | — | view | — | — | — | — | — | — | — | — | view | — | — | — | — |
| ADMIN_FINANCE | — | — | — | view, create, edit, send, sign, export | view, create, record, refund, waive, export | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | view | view | view | view | view, create, edit | view, create, edit | view | — | — | — | — |
...
| CLOSE | cases (`PATCH /cases/:id/close`) — not in 02_RBAC.md's generic list, added because Case closure has its own mandatory preconditions that a bare status PATCH can't express safely; kept as its own permission/action for the same reason CONVERT is its own action. Phase 09 extended the precondition set (still the same `cases:close` permission, same single `CasesService.close()` entry point — no new permission, no logic duplicated into a Visa/Enrollment controller): closure reason (SRS section 9) + open-task check (Phase 04) + no outstanding Payment debt (`PaymentsService.hasOutstandingDebtForCase`) + no non-terminal Visa (`VisaStatusService.hasOpenVisa`) + a CONFIRMED Enrollment once Admission was attempted (`hasUnconfirmedRequiredEnrollment`) + every required pre-departure item DONE/WAIVED once any exist (`hasIncompletePreDepartureChecklist`) — see `docs/ASSUMPTIONS.md` ASM-36. | — |
...
verification/replay-protection/audit in `apps/api/test/webhooks.e2e-spec.ts` (Phase 12).
