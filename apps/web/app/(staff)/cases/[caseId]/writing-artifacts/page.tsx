...
export default function CaseWritingArtifactsPage({ params }: { params: Promise<{ caseId: string }> }) {
  return (
...
function CaseWritingArtifactsPageInner({ params }: { params: Promise<{ caseId: string }> }) {
